...
class StaticPagesControllerTest < ActionController::TestCase
  ...
  test "should create static_page" do
    assert_difference('StaticPage.count') do
      post :create, static_page: { content: @static_page.content, published: @static_page.published, title: @static_page.title }
    end
  ...
  test "should update static_page" do
    patch :update, id: @static_page, static_page: { content: @static_page.content, published: @static_page.published, title: @static_page.title }
    assert_redirected_to static_page_path(assigns(:static_page))
  end
